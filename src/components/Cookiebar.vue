...
const content = {
  'pt-br': {
    ...
    all: {
      ...
      enable: false,
      alert:
        'Irure enim cillum ipsum proident culpa in exercitation consequat nulla dolor dolor pariatur.',
    },
    categories: [
      {
        id: 'c1',
      ...
      },
      {
        ...
        alert:
          'Non cillum laboris cupidatat aliquip proident consequat incididunt ullamco pariatur.',
        description:
    ...
    cookies: [
      ...
      },
      {
        ...
        purpose: 'Funcional',
        description:
          'Labore aliquip enim proident enim est deserunt irure ea do exercitation laboris.',
      },
      {
        id: 'k5',
        categoryId: 'c2',
        ...
        purpose: 'Funcional',
        description:
          'Nisi magna deserunt commodo mollit mollit aliquip excepteur elit nisi.',
      ...
      },
      {
        ...
        purpose: 'Estatística',
        description:
          'Voluptate consequat consequat occaecat eiusmod do amet cillum commodo esse.',
      ...
      },
      {
        ...
        purpose: 'Estatística',
        description:
          'Magna culpa ullamco occaecat proident tempor cillum qui nulla.',
        alert:
          'Eu amet labore Lorem et voluptate aute aute aute Lorem cupidatat consectetur.',
      },
      {
        id: 'k9',
        categoryId: 'c3',
        ...
        purpose: 'Estatística',
        description:
          'Laboris dolore anim consequat amet ea dolor excepteur Lorem.',
      },
    ],
    notes: [
      {
