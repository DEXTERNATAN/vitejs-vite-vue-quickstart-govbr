<template>
  <div>
    ...
    <br-message state="info" show-icon="true">
      Clique nos componentes abaixo para simular um evento de
      <strong>login/logout</strong> e observe o console do navegador para mais
      informações.
    </br-message>
    ...
    <div class="dropdown">
      ...
      <br-list v-if="userMenuVisible" id="user-menu">
        <br-item hover @click="toggleFunctionality('Funcionalidade 01')"
          >Funcionalidade 01</br-item
        >
        <br-item hover @click="toggleFunctionality('Funcionalidade 02')"
          >Funcionalidade 02</br-item
        >
        <br-item hover @click="toggleFunctionality('Funcionalidade 03')"
          >Funcionalidade 03</br-item
        >
